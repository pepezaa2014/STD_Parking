<html>
<head>
	<title>Table student for STD Parking</title>
...
echo "<tr align='center' bgcolor='#CCCCCC'><td>รหัส</td><td>ชื่อ</td><td>CardID</td><td>สถานะ</td><td>เวลา</td><td>ทะเบียนรถ</td>";
while($row = mysqli_fetch_array($result)) { 
  echo "<tr align='center bgcolor='#CCCCCC'>";
  echo "<td>" .$row["ID_SD"] .  "</td> "; 
  echo "<td>" .$row["NAME_SD"] .  "</td> ";  
